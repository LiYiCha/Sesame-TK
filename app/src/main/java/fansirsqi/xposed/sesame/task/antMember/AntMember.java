...
//            String wua = WuaUtilV2.generate(); // 传入空字符串
...
//
//        // ==浏览视频知识
//        if("liulanxinyongshipping".equals(behaviorId) && "wait_doing".equals(status)){
//          String method = "com.antgroup.zmxy.zmcustprod.biz.rpc.growthbehavior.apiGrowthBehaviorRpcManager.pushGrowthBehavior";
//
//          // 动态构建bizTime - 当前时间
//          String bizTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date());
//
//          // 动态构建outBizNo - behaviorId + 时间戳
//          String outBizNo = behaviorId + new SimpleDateFormat("yyyyMMdd").format(new Date());
//
//          String params = "[{\"behaviorId\":\""+behaviorId+"\",\"bizTime\":\""+bizTime+"\",\"outBizNo\":\""+outBizNo+"\"}]";
//          JSONObject json = new JSONObject(RequestManager.requestString(method, params));
//          if(json.optBoolean("success")){
//            Log.other(TAG, "信誉任务[浏览视频知识成功]");
//          }else {
//            Log.error(TAG + ".handleGrowthGuideTasks", "信誉任务[浏览视频知识失败] " + json);
//          }
//        }
//
//      }
...
//              || !queryResp.optBoolean("success", false)
...
//          if (adFinishJo.optBoolean("success") || "0".equals(adFinishJo.optString("errCode"))) {
