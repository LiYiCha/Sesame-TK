...
//     * 小鸡睡觉 家庭
//     */
//    fun sleepFamily(groupId: String): String {
//        val args1 = "[{\"groupId\":\"$groupId\",\"requestType\":\"RPC\",\"sceneCode\":\"ANTFARM\",\"source\":\"chInfo_ch_url-https://render.alipay.com/p/yuyan/180020010001247569/index.html\",\"spaceType\":\"ChickFamily\",\"version\":\"unknown\"}]"
//        return requestString("com.alipay.antfarm.sleep", args1)
//    }
//
//    fun wakeUp(): String {
...
//
//    //查询爱心小屋里的情况
//    fun queryLoveCabinInfo(userId: String): String {
//        val args1 = "[{\"requestType\":\"RPC\",\"sceneCode\":\"ANTFARM\",\"source\":\"LOVECABIN\"," +
//                "\"userId\":\"$userId\"}]"
...
//        val taskSceneCode =
//            if ("dailyDraw" == drawType) "ANTFARM_DAILY_DRAW_TASK" else "ANTFARM_IP_DRAW_TASK"
//        val awardType = if ("dailyDraw" == drawType) "DAILY_DRAW_TIMES" else "FAMILY_DRAW_TIME"
//
//        val args = JSONObject()
...
//        sdkPageInfo.put(
//            "pageFrom",
//            "ch_url-https://render.alipay.com/p/yuyan/180020380000000182/prizeMachine.html"
//        )
//        sdkPageInfo.put("pageNo", 1)
//        sdkPageInfo.put(
//            "pageUrl",
//            "https://render.alipay.com/p/yuyan/180020010001256918/antfarm-landing.html?caprMode=sync"
//        )
...
//
//        val params = "[" + args + "]"
//        return requestString("com.alipay.adexchange.ad.facade.xlightPlugin", params)
//    }
//
//    /**
//     * 完成广告任务
...
//
//        val params = "[" + args + "]"
//        return requestString("com.alipay.adtask.biz.mobilegw.service.interaction.finish", params)
//    }
//
//    /**
//     * 完成普通任务（无广告）
