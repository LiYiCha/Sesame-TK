...
public class WelfareCenterRpcCall extends BaseTaskRpcCall {
    ...
    public static String pointBanlance(String str) {
        return RequestManager.requestString("com.alipay.loanpromoweb.promo.group.point.pointBanlance", "[{\"queryExpireEndDate\": \"" + str + "\",\"sceneCode\": \"SUPER930\"}]");
    }
    ...
    public static String signinPlay() {
        return RequestManager.requestString("com.alipay.loanpromoweb.member.play.signinPlay", "[{\"channel\": \"miniApp\",\"needMultiple\": false,\"operation\": \"signApply\",\"playId\": \"PLAY100177545\"}]");
    }
