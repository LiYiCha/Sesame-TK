...
public class BaseModel extends Model {
     ...
     */
    @Getter
    public static final BooleanModelField autoTokenEnabled = new BooleanModelField("autoTokenEnabled", "鱼塘自动获取token", false);
    /**
     * 是否申请支付宝的后台运行权限
     */
    @Getter
    public static final BooleanModelField batteryPerm = new BooleanModelField("batteryPerm", "为目标应用申请后台运行权限", true);
